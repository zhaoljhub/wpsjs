...
public class WpsJsController {
    ...
    public String getTepList(String search) {
        ...
        map1.put( "url", "http://127.0.0.1:8080/wpsJs/getFile/红头文件.docx" );

        Map<String, String> map2 = new HashMap();
        map2.put( "id", "红头文件1.docx" );
        map2.put( "name", "红头文件1.docx" );
        map2.put( "url", "http://127.0.0.1:8080/wpsJs/getFile/红头文件1.docx" );
    ...
    public String getRepJson() {
        ...
        map2.put( "keyValue", "[{\"keyText\":\"1、\",\"keyValue\":\"请xxx批示意见可以长一点，意见可以长一点，意见可以长一点，意见可以长一点，意见可以长一点，\",\"userName\":\"张三\",\"userPicUrl\":null,\"keyDate\":\"2019年8月12日\",\"userPicSize\":0,\"fontSize\":0}," +
                ...
                "{\"keyText\":\"3、\",\"keyValue\":\"http://127.0.0.1:8080/WpsOAAssist/icon/c_bookmark.png\",\"userName\":\"尼古拉-赵四\",\"userPicUrl\":null,\"keyDate\":\"2019年8月12日 14:20:24\",\"userPicSize\":0,\"fontSize\":0}," +
                ...
                "{\"keyText\":\"5、\",\"keyValue\":\"http://127.0.0.1:8080/WpsOAAssist/icon/c_bookmark.png\",\"userName\":\"王五\",\"userPicUrl\":\"http://127.0.0.1:8080/WpsOAAssist/icon/c_bookmark.png\",\"keyDate\":\"2019年8月12日 14:20:24\",\"userPicSize\":0,\"fontSize\":0}]" );
        map2.put( "keyType", 2 );
        ...
        map4.put( "keyValue", "[{\"keyText\":\"1、\",\"keyValue\":\"请xxx批示\",\"userName\":\"张三\",\"userPicUrl\":null,\"keyDate\":\"\",\"userPicSize\":0,\"fontSize\":0}," +
                ...
                "{\"keyText\":\"3、\",\"keyValue\":\"http://127.0.0.1:8080/static/picture/test.jpg\",\"userName\":\"王五\",\"userPicUrl\":null,\"keyDate\":\"\",\"userPicSize\":0,\"fontSize\":0}]" );
        map4.put( "keyType", 2 );
        objects.add( map );
        objects.add( map2 );
        objects.add( map4 );
